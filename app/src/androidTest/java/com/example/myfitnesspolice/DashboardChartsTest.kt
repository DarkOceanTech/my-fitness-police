...
class DashboardChartsTest {
    ...
    @Test fun fullWidthChartsSwipeShowInsightsAndRefreshFromNewData() {
        ...
        compose.onNodeWithTag("weekly-Activity-value").assertIsDisplayed().assertTextEquals("72m")
