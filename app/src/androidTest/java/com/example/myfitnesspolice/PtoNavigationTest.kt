...
class PtoNavigationTest {
    ...
    @Test fun activitiesMoveToPtoAndKeepTheirConstructionWindows() {
        ...
        try {
            ...
            compose.onNode(hasText("PTO") and hasClickAction()).performClick()
            compose.onNodeWithText("Police Training Officer").assertIsDisplayed()
            ...
            activities.forEachIndexed { index, (tag, title) ->
                ...
                compose.onNodeWithText("Back to PTO").assertIsDisplayed()
    ...
    @Test fun ptoSelectionRestoresAndStaysIndependentOfArmory() {
        ...
        try {
            ...
            compose.onNodeWithText("Daily Observation Report").assertIsDisplayed()
            screenshot("dor-home")
    ...
    @Test fun finishingAnAcademyWorkoutOpensItsDorHistory() {
        ...
        try {
            ...
            compose.onNode(hasText("DOR") and hasClickAction()).assertIsSelected()
